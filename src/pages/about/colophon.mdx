...
We show the Working Notes and their annotations with Mirador, which is a zoomable image viewer that leverages the [International Image Interoperability Framework (IIIF)](https://iiif.io/). Annotations were created in [Annonatate](https://annonatate.herokuapp.com/).
