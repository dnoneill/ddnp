...
<ImageWithCaption
  src="/images/user_guide/Teaching_annotation.jpg"
  alt="Example of student annotations of a transcribed Working Notes for Bleak House"
  caption="Student annotations of the Working Notes using DDNP transcriptions and hypothes.is (web.hypothes.is)"
/>
